...
L["Absolute damage absorption value on the unit, if 10,000 damage will be absorbed, it will show 10,000."] = "Абсолютное значение поглащения юнитом урона. Если поглащается 10,000 урона - отображается 10,000."
