...
L["Configure the Extra Action Bar"] = "Настроить Extra Action Bar"
...
L["Configure the XP Bar"] = "Настройки полоски опыта"
...
L["Reputation Bar"] = "Полоска репутации"
...
For more style options you need to install Masque]=] ] = [=[Переключение увеличения кнопок
