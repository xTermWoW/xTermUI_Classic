...
function ZGV:Options_DefineOptionTables()
	...
	do
		...
		local framescalestemp,framescales={0.75,1.0,1.25,1.5,1.75},{}
	...
	do
		...
		AddOption('autoselectitem',{ type = 'toggle', width="full", _default=false, disabled = function() return not self.db.profile.questitemselector end}) -- hidden until itemscore
