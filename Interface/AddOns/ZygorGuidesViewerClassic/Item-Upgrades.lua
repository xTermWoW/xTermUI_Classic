			...
			if itemlink then
				...
				if item and itemlink then 
					...
					if success then
						...
						ZGV:Debug("&itemscore SEI slot %d scored %d/%d",slotID,score,whitescore)
...
function Upgrades:ProcessWeaponQueue()
	...
	local equipped_weapon_1_score = equipped_weapon_1 and equipped_weapon_1.score
	local equipped_weapon_2_score = equipped_weapon_2 and equipped_weapon_2.score
	...
	local best_two_score = (best_two and math.max(best_two.whitescore or 0,best_two.score or 0)) or 0
